...
export default function Fundamentals(){
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] pt-12 px-2 sm:px-0 mb-24 overflow-x-hidden w-full">
      <div className="space-y-8 w-full max-w-full sm:max-w-4xl mx-auto px-0 sm:px-0 overflow-x-hidden">
        <div className="liquid-glass p-4 sm:p-6 shadow-xl flex flex-col sm:flex-row items-center gap-2 sm:gap-4 mb-2">
        ...
        {isSEN && <>
          <div className="card p-4 sm:p-6 mb-8 max-w-full sm:max-w-4xl w-full mx-auto bg-white/95">
        ...
        <div className="liquid-glass p-4 sm:p-8 pb-4 sm:pb-6 shadow-xl bg-white/95">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-4 w-full">
            <button onClick={applyParams} className="btn-primary min-w-[100px] sm:min-w-[120px] max-w-[140px] sm:max-w-[160px] text-base text-center whitespace-nowrap flex justify-center items-center w-full sm:w-auto">Apply Custom</button>
            <div className="text-sm text-[#1a1a1a] pt-2 w-full sm:w-auto text-center sm:text-left">Current: <span className="font-medium text-[#1a1a1a]">{selected.name}</span></div>
          </div>
        </div>
        <div className="card p-4 sm:p-6 mb-8 bg-white/95">
          <RelativeErrorChart />
        </div>
        <div className="card p-4 sm:p-6 mb-8 bg-white/95">
